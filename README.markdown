...
## Copyright
Copyright © 2017-2026 [EP Studios, Inc.](http://www.epstudiossoftware.com)
...
The app also uses the [Charts](https://github.com/ChartsOrg/Charts) framework for graphing.  This framework is copyright 2016 Daniel Cohen Gindi & Philipp Jahoda, and is licensed under the [Apache License, Version 2.0](http://www.apache.org/licenses/LICENSE-2.0.html). 

The app uses [Validator](https://github.com/Maxvit5/Validator) which
uses the [MIT License](https://github.com/evgenyneu/SigmaSwiftStatistics/blob/master/LICENSE).
